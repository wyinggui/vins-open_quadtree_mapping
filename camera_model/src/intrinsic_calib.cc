...
int main(int argc, char** argv)
{
    ...
    desc.add_options()
        ...
        ("height,h", boost::program_options::value<int>(&boardSize.height)->default_value(11), "Number of inner corners on the chessboard pattern in y direction")
        ("size,s", boost::program_options::value<float>(&squareSize)->default_value(15.f), "Size of one square in mm")
        ("input,i", boost::program_options::value<std::string>(&inputDir)->default_value("/home/wyinggui/calibrationdata"), "Input directory containing chessboard images")
        ...
        ("camera-name", boost::program_options::value<std::string>(&cameraName)->default_value("mv_26806659"), "Name of camera")
